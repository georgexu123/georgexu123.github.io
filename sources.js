(() => {
  ...
  const text = {
    "zh-CN": {
      ...
      summary: "57 段 CC0 · 11 段美国政府来源 · 4 段公共领域",
    ...
    "zh-TW": {
      ...
      summary: "57 段 CC0 · 11 段美國政府來源 · 4 段公眾領域",
    ...
    en: {
      ...
      summary: "57 CC0 · 11 U.S. Government records · 4 public-domain records",
    ...
    ja: {
      ...
      summary: "CC0 57件 · 米国政府音源 11件 · パブリックドメイン 4件",
    ...
    ko: {
      ...
      summary: "CC0 57개 · 미국 정부 음원 11개 · 퍼블릭 도메인 4개",
    ...
    ru: {
      ...
      summary: "57 CC0 · 11 записей правительства США · 4 записи общественного достояния",
    ...
    de: {
      ...
      summary: "57 CC0 · 11 Aufnahmen der US-Regierung · 4 gemeinfreie Aufnahmen",
    ...
    fr: {
      ...
      summary: "57 CC0 · 11 enregistrements du gouvernement américain · 4 éléments du domaine public",
